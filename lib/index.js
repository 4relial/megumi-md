          ...
          if (!g.func.parameter(body)) {
            sock.sendMessage(from, {
              ...
              sections: [{
                ...
                rows: [{ title: 'Kiana Kaslana', rowId: myPrefix + "in2208 Kiana Kaslana 43" },
                { title: 'Bronya Zaychik', rowId: myPrefix + "in2208 Bronya Zaychik 26" },
                { title: 'Durandal', rowId: myPrefix + "in2208 Durandal 4 " },
                { title: 'Fu Hua', rowId: myPrefix + "in2208 Fu Hua 18" },
                { title: 'Liliya Olenyeva', rowId: myPrefix + "in2208 Liliya Olenyeva 7 " },
                { title: 'Rozaliya Olenyeva', rowId: myPrefix + "in2208 Rozaliya Olenyeva 9 " },
                { title: 'Raiden Mei', rowId: myPrefix + "in2208 Raiden Mei 34" },
                { title: 'Rita Rossweisse', rowId: myPrefix + "in2208 Rita Rossweisse 24" },
                { title: 'Seele Vollerei', rowId: myPrefix + "in2208 Seele Vollerei 20" },
                { title: 'Theresa Apocalypse', rowId: myPrefix + "in2208 Theresa Apocalypse 27" },
                { title: 'Yae Sakura', rowId: myPrefix + "in2208 Yae Sakura 37" }]
              }]
            })
            break
          }
          ...
          if (!g.func.parameter(body)) {
            sock.sendMessage(from, {
              ...
              sections: [{
                title: "Daftar Karakter",
                rows: [
                  { title: 'Amber', rowId: myPrefix + "in2208 Amber (Genshin Impact) 30" },
                  { title: 'Yae Miko', rowId: myPrefix + "in2208 Yae Miko 77" },
                  { title: 'Raiden Shogun', rowId: myPrefix + "in2208 Raiden Shogun 99" },
                  { title: 'Ganyu', rowId: myPrefix + "in2208 ganyu 99" },
                  { title: 'Hu Tao', rowId: myPrefix + "in2208 hu tao 99" },
                  { title: 'Yoimiya', rowId: myPrefix + "in2208 yoimiya 18" },
                  { title: 'Eula', rowId: myPrefix + "in2208 eula 66" },
                  { title: 'Kamisato Ayaka', rowId: myPrefix + "in2208 kamisato ayaka 44" },
                  { title: 'Keqing', rowId: myPrefix + "in2208 Keqing 99" },
                  { title: 'Fischl ', rowId: myPrefix + "in2208 Fischl 50" },
                  { title: 'Barbara ', rowId: myPrefix + "in2208 Barbara (Genshin Impact) 59" },
                  { title: 'Sangonomiya Kokomi', rowId: myPrefix + "in2208 Sangonomiya Kokomi 57" }
                ]
              }]
            })
            break
          ...
          if (!parameter) {
            sock.sendMessage(from, {
              ...
              sections: [{
                title: "Daftar Karakter",
                rows: [
                  { title: 'Infinite Ouroboros', rowId: myPrefix + "er io" },
                  { title: 'Miss Pink Elf♪', rowId: myPrefix + "er ely" },
                  { title: 'Palatinus Equinox', rowId: myPrefix + "er pe" },
                  { title: 'Spina Astera', rowId: myPrefix + "er ritasa" },
                  { title: 'Herrscher of Flamescion', rowId: myPrefix + "er hof" },
                  { title: 'SILVERWING: N-EX', rowId: myPrefix + "er sw" },
                  { title: 'Dea Anchora', rowId: myPrefix + "er dea" },
                  { title: 'Herrscher of YATTA', rowId: myPrefix + "er hos" },
                  { title: 'Argent Knight: Artemis', rowId: myPrefix + "er aka" },
                  { title: 'Starchasm Nyx', rowId: myPrefix + "er nyx" },
                  { title: 'Herrscher of Reason', rowId: myPrefix + "er hor" },
                  { title: 'Prinzessin der Verurteilung', rowId: myPrefix + "er faisal" },
                  { title: 'Herrscher of Thunder (Basic Attack)', rowId: myPrefix + "er hot" },
                  { title: 'Herrscher of Thunder (Burst)', rowId: myPrefix + "er hotburst" },
                  { title: 'Twilight Paladin', rowId: myPrefix + "er tp" },
                  { title: 'Midnight Absinthe', rowId: myPrefix + "er ma" },
                  { title: 'Valkyrie Bladestrike', rowId: myPrefix + "er sf" },
                  { title: 'Stygian Nymph', rowId: myPrefix + "er sn" },
                  { title: 'Bright Knight: Excelsisn', rowId: myPrefix + "er bke" },
                  { title: 'Valkyrie Gloria', rowId: myPrefix + "er vg" },
                  { title: 'Ritual Imayoh', rowId: myPrefix + "er ri" },
                  { title: 'Luna Kindred', rowId: myPrefix + "er lk" },
                  { title: 'Sweet n Spicy', rowId: myPrefix + "er snc" },
                  { title: 'Pardofelis', rowId: myPrefix + "er felis" },
                  { title: 'Fallen Rosemary', rowId: myPrefix + "er fr" },
                  { title: 'Aphonia', rowId: myPrefix + "er aphonia" },
                  { title: 'EDEN', rowId: myPrefix + "er eden" },
                  { title: 'Griseo', rowId: myPrefix + "er griseo" },
                  { title: 'Fervent Tempo', rowId: myPrefix + "er ft" },
                  { title: 'Herrscher of Human: Ego', rowId: myPrefix + "er hoh" },
                  { title: 'Herrscher of Void', rowId: myPrefix + "er hov" },
                  { title: 'Kubis (AI CHWAN)', rowId: myPrefix + "er kubis" },
                  { title: 'Jade Knight (Li Sushang)', rowId: myPrefix + "er sus" },
                  { title: 'Ma-- Vermilion Knight', rowId: myPrefix + "er veki" }
                ]
              }]
            })
            break
      ...
      case 'giascend':
        {
          ...
          sock.sendMessage(from, {
            ...
            sections: [{
              title: "Daftar Karakter",
              rows: [
                { title: "Albedo", rowId: myPrefix + "sheet Character_Albedo" },
                { title: "Aloy", rowId: myPrefix + "sheet Character_Aloy" },
                { title: "Amber", rowId: myPrefix + "sheet Character_Amber" },
                { title: "AnemoTraveler", rowId: myPrefix + "sheet Character_AnemoTraveler" },
                { title: "Ayaka", rowId: myPrefix + "sheet Character_Ayaka" },
                { title: "Ayato", rowId: myPrefix + "sheet Character_Ayato" },
                { title: "Barbara", rowId: myPrefix + "sheet Character_Barbara" },
                { title: "Beidou", rowId: myPrefix + "sheet Character_Beidou" },
                { title: "Bennett", rowId: myPrefix + "sheet Character_Bennett" },
                { title: "Candace", rowId: myPrefix + "sheet Character_Candace" },
                { title: "Chongyun", rowId: myPrefix + "sheet Character_Chongyun" },
                { title: "Collei", rowId: myPrefix + "sheet Character_Collei" },
                { title: "Cyno", rowId: myPrefix + "sheet Character_Cyno" },
                { title: "Diluc", rowId: myPrefix + "sheet Character_Diluc" },
                { title: "Diona", rowId: myPrefix + "sheet Character_Diona" },
                { title: "Dori", rowId: myPrefix + "sheet Character_Dori" },
                { title: "ElectroTraveler", rowId: myPrefix + "sheet Character_ElectroTraveler" },
                { title: "Eula", rowId: myPrefix + "sheet Character_Eula" },
                { title: "Faruzan", rowId: myPrefix + "sheet Character_Faruzan" },
                { title: "Fischl", rowId: myPrefix + "sheet Character_Fischl" },
                { title: "Ganyu", rowId: myPrefix + "sheet Character_Ganyu" },
                { title: "GeoTraveler", rowId: myPrefix + "sheet Character_GeoTraveler" },
                { title: "Gorou", rowId: myPrefix + "sheet Character_Gorou" },
                { title: "Heizou", rowId: myPrefix + "sheet Character_Heizou" },
                { title: "Itto", rowId: myPrefix + "sheet Character_Itto" },
                { title: "Jean", rowId: myPrefix + "sheet Character_Jean" },
                { title: "Kaeya", rowId: myPrefix + "sheet Character_Kaeya" },
                { title: "Kazuha", rowId: myPrefix + "sheet Character_Kazuha" },
                { title: "Keqing", rowId: myPrefix + "sheet Character_Keqing" },
                { title: "Klee", rowId: myPrefix + "sheet Character_Klee" },
                { title: "Kokomi", rowId: myPrefix + "sheet Character_Kokomi" },
                { title: "Layla", rowId: myPrefix + "sheet Character_Layla" },
                { title: "Lisa", rowId: myPrefix + "sheet Character_Lisa" },
                { title: "Mona", rowId: myPrefix + "sheet Character_Mona" },
                { title: "Nahida", rowId: myPrefix + "sheet Character_Nahida" },
                { title: "Nilou", rowId: myPrefix + "sheet Character_Nilou" },
                { title: "Ningguang", rowId: myPrefix + "sheet Character_Ningguang" },
                { title: "Noelle", rowId: myPrefix + "sheet Character_Noelle" },
                { title: "Qiqi", rowId: myPrefix + "sheet Character_Qiqi" },
                { title: "Raiden", rowId: myPrefix + "sheet Character_Raiden" },
                { title: "Razor", rowId: myPrefix + "sheet Character_Razor" },
                { title: "Rosaria", rowId: myPrefix + "sheet Character_Rosaria" },
                { title: "Sara", rowId: myPrefix + "sheet Character_Sara" },
                { title: "Sayu", rowId: myPrefix + "sheet Character_Sayu" },
                { title: "Shenhe", rowId: myPrefix + "sheet Character_Shenhe" },
                { title: "Shinobu", rowId: myPrefix + "sheet Character_Shinobu" },
                { title: "Sucrose", rowId: myPrefix + "sheet Character_Sucrose" },
                { title: "Tartaglia", rowId: myPrefix + "sheet Character_Tartaglia" },
                { title: "Thoma", rowId: myPrefix + "sheet Character_Thoma" },
                { title: "Tighnari", rowId: myPrefix + "sheet Character_Tighnari" },
                { title: "Venti", rowId: myPrefix + "sheet Character_Venti" },
                { title: "Wanderer", rowId: myPrefix + "sheet Character_Wanderer" },
                { title: "Xiao", rowId: myPrefix + "sheet Character_Xiao" },
                { title: "Xingqiu", rowId: myPrefix + "sheet Character_Xingqiu" },
                { title: "Xinyan", rowId: myPrefix + "sheet Character_Xinyan" },
                { title: "Yae", rowId: myPrefix + "sheet Character_Yae" },
                { title: "Yanfei", rowId: myPrefix + "sheet Character_Yanfei" },
                { title: "Yelan", rowId: myPrefix + "sheet Character_Yelan" },
                { title: "YunJin", rowId: myPrefix + "sheet Character_YunJin" },
                { title: "Yoimiya", rowId: myPrefix + "sheet Character_Yoimiya" },
                { title: "Zhongli", rowId: myPrefix + "sheet Character_Zhongli" },
      ...
      case 'gibuild':
        {
          ...
          sock.sendMessage(from, {
            ...
            sections: [{
              title: "Daftar Karakter",
              rows: [
                { title: "Albedo", rowId: myPrefix + "sheet2 Character_Albedo" },
                { title: "Aloy", rowId: myPrefix + "sheet2 Character_Aloy" },
                { title: "Amber", rowId: myPrefix + "sheet2 Character_Amber" },
                { title: "AmberDPS", rowId: myPrefix + "sheet2 Character_AmberDPS" },
                { title: "Ayaka", rowId: myPrefix + "sheet2 Character_Ayaka" },
                { title: "Ayato", rowId: myPrefix + "sheet2 Character_Ayato" },
                { title: "AyatoDPS", rowId: myPrefix + "sheet2 Character_AyatoDPS" },
                { title: "Barbara", rowId: myPrefix + "sheet2 Character_Barbara" },
                { title: "Beidou", rowId: myPrefix + "sheet2 Character_Beidou" },
                { title: "Bennett", rowId: myPrefix + "sheet2 Character_Bennett" },
                { title: "Candace", rowId: myPrefix + "sheet2 Character_Candace" },
                { title: "Chongyun", rowId: myPrefix + "sheet2 Character_Chongyun" },
                { title: "Collei", rowId: myPrefix + "sheet2 Character_Collei" },
                { title: "Cyno", rowId: myPrefix + "sheet2 Character_Cyno" },
                { title: "Diluc", rowId: myPrefix + "sheet2 Character_Diluc" },
                { title: "Diona", rowId: myPrefix + "sheet2 Character_Diona" },
                { title: "Dori", rowId: myPrefix + "sheet2 Character_Dori" },
                { title: "Eula", rowId: myPrefix + "sheet2 Character_Eula" },
                { title: "Faruzan", rowId: myPrefix + "sheet2 Character_Faruzan" },
                { title: "Fischl", rowId: myPrefix + "sheet2 Character_Fischl" },
                { title: "Ganyu", rowId: myPrefix + "sheet2 Character_Ganyu" },
                { title: "Ganyu_Freeze", rowId: myPrefix + "sheet2 Character_Ganyu_Freeze" },
                { title: "Ganyu_Melt", rowId: myPrefix + "sheet2 Character_Ganyu_Melt" },
                { title: "Gorou", rowId: myPrefix + "sheet2 Character_Gorou" },
                { title: "Heizou", rowId: myPrefix + "sheet2 Character_Heizou" },
                { title: "HuTao", rowId: myPrefix + "sheet2 Character_HuTao" },
                { title: "Itto", rowId: myPrefix + "sheet2 Character_Itto" },
                { title: "Jean", rowId: myPrefix + "sheet2 Character_Jean" },
                { title: "Kaeya", rowId: myPrefix + "sheet2 Character_Kaeya" },
                { title: "KaeyaDPS", rowId: myPrefix + "sheet2 Character_KaeyaDPS" },
                { title: "Kazuha", rowId: myPrefix + "sheet2 Character_Kazuha" },
                { title: "Keqing_Electro", rowId: myPrefix + "sheet2 Character_Keqing_Electro" },
                { title: "Keqing_Physical", rowId: myPrefix + "sheet2 Character_Keqing_Physical" },
                { title: "Klee", rowId: myPrefix + "sheet2 Character_Klee" },
                { title: "Kokomi", rowId: myPrefix + "sheet2 Character_Kokomi" },
                { title: "Layla", rowId: myPrefix + "sheet2 Character_Layla" },
                { title: "Lisa", rowId: myPrefix + "sheet2 Character_Lisa" },
                { title: "LisaDPS", rowId: myPrefix + "sheet2 Character_LisaDPS" },
                { title: "Mona", rowId: myPrefix + "sheet2 Character_Mona" },
                { title: "Mona_Freeze", rowId: myPrefix + "sheet2 Character_Mona_Freeze" },
                { title: "Mona_Nuke", rowId: myPrefix + "sheet2 Character_Mona_Nuke" },
                { title: "Nahida", rowId: myPrefix + "sheet2 Character_Nahida" },
                { title: "Nilou", rowId: myPrefix + "sheet2 Character_Nilou" },
                { title: "Ningguang", rowId: myPrefix + "sheet2 Character_Ningguang" },
                { title: "NingguangDPS", rowId: myPrefix + "sheet2 Character_NingguangDPS" },
                { title: "Noelle", rowId: myPrefix + "sheet2 Character_Noelle" },
                { title: "Qiqi", rowId: myPrefix + "sheet2 Character_Qiqi" },
                { title: "Raiden", rowId: myPrefix + "sheet2 Character_Raiden" },
                { title: "Razor", rowId: myPrefix + "sheet2 Character_Razor" },
                { title: "Rosaria", rowId: myPrefix + "sheet2 Character_Rosaria" },
                { title: "Sara", rowId: myPrefix + "sheet2 Character_Sara" },
                { title: "Sayu", rowId: myPrefix + "sheet2 Character_Sayu" },
                { title: "Shenhe", rowId: myPrefix + "sheet2 Character_Shenhe" },
                { title: "Shinobu", rowId: myPrefix + "sheet2 Character_Shinobu" },
                { title: "Sucrose", rowId: myPrefix + "sheet2 Character_Sucrose" },
                { title: "Tartaglia", rowId: myPrefix + "sheet2 Character_Tartaglia" },
                { title: "Thoma", rowId: myPrefix + "sheet2 Character_Thoma" },
                { title: "Tighnari", rowId: myPrefix + "sheet2 Character_Tighnari" },
                { title: "Traveler_Anemo", rowId: myPrefix + "sheet2 Character_Traveler_Anemo" },
                { title: "Traveler_Dendro", rowId: myPrefix + "sheet2 Character_Traveler_Dendro" },
                { title: "Traveler_Electro", rowId: myPrefix + "sheet2 Character_Traveler_Electro" },
                { title: "Traveler_Geo", rowId: myPrefix + "sheet2 Character_Traveler_Geo" },
                { title: "Venti", rowId: myPrefix + "sheet2 Character_Venti" },
                { title: "Wanderer", rowId: myPrefix + "sheet2 Character_Wanderer" },
                { title: "Xiangling", rowId: myPrefix + "sheet2 Character_Xiangling" },
                { title: "XianglingDPS", rowId: myPrefix + "sheet2 Character_XianglingDPS" },
                { title: "Xiao", rowId: myPrefix + "sheet2 Character_Xiao" },
                { title: "XiaoDPS", rowId: myPrefix + "sheet2 Character_XiaoDPS" },
                { title: "Xingqiu", rowId: myPrefix + "sheet2 Character_Xingqiu" },
                { title: "Xinyan", rowId: myPrefix + "sheet2 Character_Xinyan" },
                { title: "Yae", rowId: myPrefix + "sheet2 Character_Yae" },
                { title: "Yanfei", rowId: myPrefix + "sheet2 Character_Yanfei" },
                { title: "YanfeiDPS", rowId: myPrefix + "sheet2 Character_YanfeiDPS" },
                { title: "Yelan", rowId: myPrefix + "sheet2 Character_Yelan" },
                { title: "Yoimiya", rowId: myPrefix + "sheet2 Character_Yoimiya" },
                { title: "YunJin", rowId: myPrefix + "sheet2 Character_YunJin" },
                { title: "Yoimiya", rowId: myPrefix + "sheet2 Character_Yoimiya" },
                { title: "Zhongli", rowId: myPrefix + "sheet2 Character_Zhongli" },
      ...
      case `menu`:
        {
          ...
          if (isPrem) {
            ...
            buttontext = "Owner"
            buttonid = myPrefix + "owner"
            teks = conf.bot.bigName
          } else {
            teks = daftarTeks.menuBotFree(mei.pushName)
            buttontext = "Premium Now!"
            buttonid = myPrefix + "premium"
            footer = conf.bot.bigName
          }
